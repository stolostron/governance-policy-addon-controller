...
require (
	...
	open-cluster-management.io/sdk-go v0.0.0-20240122034348-9793ade2466b // indirect
)
...
require (
	...
	helm.sh/helm/v3 v3.14.1 // indirect; CVE-2024-25620: >=v3.14.1
...
replace (
	go.opentelemetry.io/contrib/instrumentation/net/http/otelhttp => go.opentelemetry.io/contrib/instrumentation/net/http/otelhttp v0.44.0 // CVE-2023-45142 (v0.44.0)
