...
`klusterletaddonconfig-pause` annotation is required on the `KlusterletAddonConfig` to add the
`addon.open-cluster-management.io/values` annotation overrides in the `ManagedClusterAddon`.
